...
public abstract class Hilt_DeckListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DeckListFragment() {
    super();
  }

  Hilt_DeckListFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DeckListFragment_GeneratedInjector) this.generatedComponent()).injectDeckListFragment(UnsafeCasts.<DeckListFragment>unsafeCast(this));
    }
  }
