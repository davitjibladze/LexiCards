...
public abstract class Hilt_StudyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StudyFragment_GeneratedInjector) this.generatedComponent()).injectStudyFragment(UnsafeCasts.<StudyFragment>unsafeCast(this));
    }
  }
