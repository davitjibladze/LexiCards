...
public abstract class Hilt_CardListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardListFragment() {
    super();
  }

  Hilt_CardListFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardListFragment_GeneratedInjector) this.generatedComponent()).injectCardListFragment(UnsafeCasts.<CardListFragment>unsafeCast(this));
    }
  }
